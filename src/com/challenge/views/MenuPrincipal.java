...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Victor Rdz y AluraLatam © 2023");
		lblCopyR.setBounds(285, 11, 369, 19);
		lblCopyR.setForeground(new Color(240, 248, 255));
		lblCopyR.setFont(new Font("Eras Medium ITC", Font.PLAIN, 16));
		...
		btnSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Mensaje mensaje = new Mensaje("¿Desea salir de la aplicación?", 2);
		...
		lblTitulo.setFont(new Font("Eras Light ITC", Font.PLAIN, 20));
		// Botón Login
		...
		btnEntrar.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/login.png")));
		btnEntrar.setBounds(754, 300, 80, 70);
		panel.add(btnEntrar);
	}
